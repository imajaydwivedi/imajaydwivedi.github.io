...
Site Reliability Engineer with 14+ years of experience, I automate infrastructure using DevOps CI/CD pipelines leveraging scripting tools like Python, Ansible, GitHub Actions, PowerShell, Containers etc. I build monitoring and alerting systems using tools like Python, Flask, PowerShell, Prometheus and Grafana for both On-Prem and Cloud platform (AWS & Azure).


## Skills

**Databases:** <span class="iconify" data-icon="vscode-icons:file-type-sqlserver"></span> PostgreSQL, SQLServer, RDS, Aurora PostgreSQL, Azure SQL, Managed Instance

**Programming Languages:** <span class="iconify" data-icon="vscode-icons:file-type-python"></span> Python, <span class="iconify" data-icon="vscode-icons:file-type-sql"></span> SQL, <span class="iconify" data-icon="vscode-icons:file-type-powershell"></span> PowerShell, <span class="iconify" data-icon="vscode-icons:file-type-js-official"></span> JavaScript, <span class="iconify" data-icon="vscode-icons:file-type-html"></span> HTML / <span class="iconify" data-icon="vscode-icons:file-type-css"></span> CSS, <span class="iconify" data-icon="vscode-icons:file-type-shell"></span> Shell Scripting

**Tools and Frameworks:** Git, Linux, Ansible, Flask, Django, GitHub Actions, VS Code, Grafana, Prometheus, KVM Virtualization, Container, Podman, Docker, Ubuntu, RHEL, PowerShell DSC, Infrastructure as Code (IaC), Consul, Vault, Nginx

**Cloud Platforms:** AWS, Azure

**High Availability & Disaster Recovery:** Streaming Replication, Multi DC Clustering, Availability Groups, Mirroring, Log Shipping, transactional Replication, Disk Stripping, RAID, Multi Subnet Setup
...
- Created python alert automation for disk, connectivity, patroni health, and backup failiure for PostgreSQL servers.
- Built Python Package for Common Database Administration tasks like multi server querying, auditing PostgreSQL clusters for security practices etc.
...
- Build Python flask application (Alert Engine) for alerting in SQLServer environment for regular metrics like cpu, disk, memory, blocking, high sev errors, configuration changes etc.
